...
y1_3 = 0.7 * x1_1d * x1_1d - 0.4 * x1_1d + 1.5 + noise
...
#given the 50 x-values and y-values (as defined) find the best coefficents in the form ax^2+bx+c, and return an array (degree=2)
coef = np.polyfit(x1_1d, y1_2,2)
...
print('\t2D Data: Intercept: {0} Coefficients: {1}'.format(coef[2], coef[:2]))
...
# predict for inputs along the graph to find the best-fit line, plug in all x-values into 2nd degree equation given the coefficients
